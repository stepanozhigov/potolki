    ...
    <div class="container">
        <div class="geoConfirm__content">
            <div class="geoConfirm__city"> 
                ...
                <p class="geoConfirm__city-text">Ваш город <span class="geoConfirm__city-name">Сочи</span> </p>
            </div>
            <button class="geoConfirm__confirm">Да, верно</button>
            <button class="geoConfirm__choose">Нет, сменить город</button>
        </div>
        <div class="geoConfirm__choose-city">
            <div class="geoConfirm__choose-content">
                <a href="javascript:void(0);" class="geoConfirm__choose-link">Артем</a>
                <a href="javascript:void(0);" class="geoConfirm__choose-link">Благовещенск</a>
                <a href="javascript:void(0);" class="geoConfirm__choose-link">Владивосток</a>
                <a href="javascript:void(0);" class="geoConfirm__choose-link">Краснодар</a>
                <a href="javascript:void(0);" class="geoConfirm__choose-link">Находка</a>
                <a href="javascript:void(0);" class="geoConfirm__choose-link">Уссурийск</a>
                <a href="javascript:void(0);" class="geoConfirm__choose-link">Хабаровск</a>
            </div>
        </div>
    </div>
</div>
