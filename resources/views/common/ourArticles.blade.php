<section class="ourArticles">
    @include('common.gui.titles', ['secondTitle' => 'Статьи и полезная информация'])
    <p class="intro titles__intro">
        Вы можете прочитать все статьи в удобной для вас социальной сети
    </p>
    ...
    <div class="ourArticles__list">
        <div class="ourArticles__content">
            ...
            <article class="ourArticle">
                <div class="ourArticle__gallery">
                    <video class="ourArticle__img active" controls="controls" src="/storage/reviews/52/aleksandr-velichko-video-otzyv.qt" poster="posterimage.jpg"></video>
                    <img src="/img/ourArticle_3.png" class="ourArticle__img" alt="">
                    <img src="/img/ourArticle_2.png" class="ourArticle__img" alt="">
                    <img src="/img/ourArticle_3.png" class="ourArticle__img" alt="">
                    <button class="ourArticle__gallery-prev"></button>
        ...
        <button class="ourArticles__slide ourArticles__prev"><img src="/img/gui/arrow_light.png"></button>
        <button class="ourArticles__slide ourArticles__next"><img src="/img/gui/arrow_light.png"></button>
    </div>
    <a href="http://89.108.103.224/sochi/articles" class="ourArticles__button">Читать остальные статьи</a>
