<template>
    <div class="portfolio__wrapper">
        ...
        <div class="portfolio__carousel">
            <a v-touch:swipe="offsetShowPoint" v-touch:swipe.left="offsetBackShowPoint" @click="toggleMode(index)" v-for="(photo, index) in showedItems" v-bind:key="photo.id" class="case b-card portfolio__item portfolio__item_slide">
