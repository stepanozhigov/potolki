  ...
  methods: {
    ...
    submitForm: function submitForm(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/lead', {
        ...
        return console.log(_this.gifts[_this.questions.gift].title), _this.step = 5, _this.questions.type = '', _this.questions.disign = '', _this.questions.price = '', _this.questions.phoneclear = '';
      });
    },
