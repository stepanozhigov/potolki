  ...
  methods: {
    ...
    submitQuiz: function submitQuiz(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/forms/quiz2', {
        ...
        return _this.step = 5, Vue.cookie.set('form_send', true, 1), window.yaCounter40202559.reachGoal('quiz'), fbq('track', 'Lead'), ga.getAll()[0].send('event', 'quiz', 'send');
      });
    },
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", [
      ...
      _c("h1", { staticClass: "hero_title" }, [
        _vm._v("Получите расчёт натяжного потолка "),
        _c("br"),
  ...
  function() {
    ...
    return _c("div", { staticClass: "quest__titles" }, [
      ...
      _vm._v(" "),
      _c("p", { staticClass: "quest_title" }, [
        _vm._v("Получите расчёт натяжного потолка и подарок")
      ])
    ])
  },
  function() {
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('quiz', __webpack_require__(/*! ./views/Quiz.vue */ "./resources/assets/js/quiz/views/Quiz.vue"));
