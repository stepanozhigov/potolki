  ...
  methods: {
    ...
    submitQuiz: function submitQuiz(e) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/forms/quiz2', {
        ...
        return _this.step = 5, Vue.cookie.set('form_send', true, 1), window.yaCounter40202559.reachGoal('quiz'), fbq('track', 'Lead'), ga.getAll()[0].send('event', 'quiz', 'send'), setTimeout(function () {
          window.location.href = '/' + _this.cityLink;
        }, 4000);
      });
    },
